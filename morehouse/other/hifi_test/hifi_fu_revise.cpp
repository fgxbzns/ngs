...
// max compare len ori 300
#define MAXCOMPARELEN 100
...
/* merge hap and geno. the two pos list may have distinct positions. 
 * a: hap position array, na: hap total snp number
 * b: geno position array, nb: geno total snp number
 * c: hap geno union. a sorted array with all the positions in hap and geno
 * nc is the size hg_union, initial value is 0. when the program is finished, it is updated as the size of the array
 * Sep 24 2013, Fu and Rao
 */
