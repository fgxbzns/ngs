...
for position, line_hifi in snp_hap_hifi_dict.iteritems():
	if position in snp_hap_ori_dict:
		...
		if elements_hifi[2].strip() == elements_ori[2].strip():	#A is A
		#if elements_hifi[2].strip() == elements_ori[3].strip():	#A is B
			if elements_hifi[3].strip() == elements_ori[3].strip():
			#if elements_hifi[3].strip() == elements_ori[2].strip():
				same_AB_total_number += 1	# same AB
			else:
				same_A_total_number += 1	# same A
		elif elements_hifi[3].strip() == elements_ori[3].strip():
		#elif elements_hifi[3].strip() == elements_ori[2].strip():
			same_B_total_number += 1	# same B
		elif elements_ori[2].strip() == "X" or elements_ori[3].strip() == "X" or elements_ori[2].strip() == "N" or elements_ori[3].strip() == "N":
			#print elements_ori[2].strip(), elements_hifi[3].strip()
			same_AB_total_number += 1	# same AB
		else:
