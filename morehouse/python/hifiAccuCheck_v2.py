...
def compare_std_result(hifi_result_dict, hifi_std_dict):
	...
	same_to_AB_dict = {}
	not_same_to_AB_dict = {}
	global same_position_total_number
	global different_position_total_number
	...
	for position, elements_hifi in hifi_result_dict.iteritems():
		if position in hifi_std_dict:
			...
			print >> difference_output_file, elements_hifi
	return (same_to_A_dict, same_to_B_dict, same_to_AB_dict, not_same_to_AB_dict)
