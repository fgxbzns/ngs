...
# to check if seed error has been corrected in imputated haplotype
...
error_distribution_output_file_name = seed_file + "_seed_consistence"
error_distribution_output_file = open(currentPath + error_distribution_output_file_name, "w")
print >> error_distribution_output_file, "rsID \t pos \t std_A \t std_B \t seed_ori \t seed_hifi_imputed"
