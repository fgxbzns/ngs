...
file_path = "/home/guoxing/disk2/dgv_struct_val/" # for structral val
...
rmsk_file = "segdups_hg18.txt"
sam_file = "song_5_2_noPri_chr.sam"
sam_file = "song_5_2_removePri_chr.sam"
sam_file = "song_5_2_removePri_chr_sorted_kept_kept.sam"
#sam_file = "song_5_2_noPri_chr_sorted_kept_kept.sam"
...
outputFile_sam = open(currentPath + sam_file_name + "_segdups.sam", "w")
