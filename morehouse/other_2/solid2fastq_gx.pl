...
getopts('', \%opts);
die($usage) if (@ARGV != 3);
my ($title, $pre, $flag) = @ARGV;
my (@fhr, @fhw);
#my $csfasta="BC_song_".$flag.".csfasta";
#my $qual="BC_QV_song_".$flag.".qual";
my $csfasta="F3_song_".$flag.".csfasta";
my $qual="F3_QV_song_".$flag.".qual";
my @fn_suff = ($csfasta, $qual, 'R3.csfasta', 'R3_QV.qual');
